    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("Поставьте курсор в любое текстовое поле и нажмите хоткей (или пункт «Диктовка» в меню в трее): появится плавающая панель с волной и таймером. ⏹ отменяет, ✓ распознаёт и вставляет текст.")
                    .font(.caption).foregroundColor(.secondary)
            }
